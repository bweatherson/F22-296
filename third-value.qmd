...
Let's solve this by brute force, with a table.^[For some reason $\vee$ and $\wedge$ aren't showing up in headers in the software I'm using, so I'm using & for _and_.]
