...
-   Twelve Quizzes, of which the best 10 will count: 7% each, for a total of 70%;
-   Final Exam: 20%.

\newpage

The course is in three parts: Classical Logic, which is weeks 1-3; Modal Logic, which is weeks 4-?, and Non-Classical Logic, which is weeks ?-?. The readings other than the Priest book are mostly linked here. Some of the links require UM authorisation; it's easiest to simply be on campus when you access them.
