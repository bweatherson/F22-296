...
- For any point, we can consider the question, is $p$ true at that point and all subsequent points?
...
Consider not just an individual frame, but a whole set of frames. A sentence $A$ **charactierises** that set if the following two things hold.
